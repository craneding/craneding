...
public interface TranslatorWebServiceSoap {
     ...
     * @param word
     * @return
     *     returns com.webxml.translator.ArrayOfString
     */
    ...
    @RequestWrapper(localName = "getEnCnTwoWayTranslator", targetNamespace = "http://WebXml.com.cn/", className = "com.webxml.translator.GetEnCnTwoWayTranslator")
    @ResponseWrapper(localName = "getEnCnTwoWayTranslatorResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.webxml.translator.GetEnCnTwoWayTranslatorResponse")
    ...
    @RequestWrapper(localName = "HelloWebXml", targetNamespace = "http://WebXml.com.cn/", className = "com.webxml.translator.HelloWebXml")
    @ResponseWrapper(localName = "HelloWebXmlResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.webxml.translator.HelloWebXmlResponse")
